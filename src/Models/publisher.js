...
exports.create = nameSpace => {
    return pool.myExecute('DROP TABLE IF EXISTS `:nameSpaceUsers`; CREATE TABLE IF NOT EXISTS `:nameSpaceUsers` (`id` INTEGER NOT NULL auto_increment UNIQUE , `userName` VARCHAR(255) NOT NULL, `mail` VARCHAR(255) UNIQUE, `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB;DROP TABLE IF EXISTS `:nameSpaceRRCs`; CREATE TABLE IF NOT EXISTS `:nameSpaceRRCs` (`id` INTEGER NOT NULL auto_increment UNIQUE , `parent` INTEGER NULL, `data` JSON,`admin` INTEGER NOT NULL, `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL, PRIMARY KEY (`id`), FOREIGN KEY (`admin`) REFERENCES `:nameSpaceUsers`(`id`) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (`parent`) REFERENCES `:nameSpaceRRCs`(`id`) ON DELETE CASCADE ON UPDATE CASCADE) ENGINE=InnoDB;DROP TABLE IF EXISTS `:nameSpaceRSCs`; CREATE TABLE IF NOT EXISTS `:nameSpaceRSCs` (`room` INTEGER NOT NULL, `user` INTEGER NOT NULL, `accessLevel` VARCHAR(255), `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL, PRIMARY KEY (`room`,`user`), FOREIGN KEY (`room`) REFERENCES `:nameSpaceRRCs`(`id`) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (`user`) REFERENCES `:nameSpaceUsers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE) ENGINE=InnoDB;DROP TABLE IF EXISTS `:nameSpaceERCs`; CREATE TABLE IF NOT EXISTS `:nameSpaceERCs` (`id` INTEGER NOT NULL auto_increment UNIQUE , `data` JSON NOT NULL, `room` INTEGER NOT NULL,`author` INTEGER NOT NULL, `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL, PRIMARY KEY (`id`), FOREIGN KEY (`room`) REFERENCES `:nameSpaceRRCs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY (`author`) REFERENCES `:nameSpaceUsers`(`id`) ON DELETE CASCADE ON UPDATE CASCADE) ENGINE=InnoDB;DROP TABLE IF EXISTS `:nameSpaceESCs`;CREATE TABLE IF NOT EXISTS `:nameSpaceESCs` (`relation` VARCHAR(255), `record` INTEGER NOT NULL, `user` INTEGER NOT NULL, `createdAt` DATETIME NOT NULL, `updatedAt` DATETIME NOT NULL, PRIMARY KEY (`record`,`user`), FOREIGN KEY (`record`) REFERENCES `:nameSpaceERCs` (`id`), FOREIGN KEY (`user`) REFERENCES `:nameSpaceUsers` (`id`)) ENGINE=InnoDB;',{
